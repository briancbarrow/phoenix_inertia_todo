...
config :inertia_todo,
  ecto_repos: [InertiaTodo.Repo],
  generators: [timestamp_type: :utc_datetime]

# Configures the endpoint
config :inertia_todo, InertiaTodoWeb.Endpoint,
  url: [host: "localhost"],
  adapter: Bandit.PhoenixAdapter,
  render_errors: [
    formats: [html: InertiaTodoWeb.ErrorHTML, json: InertiaTodoWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: InertiaTodo.PubSub,
  live_view: [signing_salt: "+06ghPdS"]
...
config :inertia_todo, InertiaTodo.Mailer, adapter: Swoosh.Adapters.Local
...
config :inertia,
  ...
  endpoint: InertiaTodoWeb.Endpoint,
